...
Не забываем загрузжать всё на GitHub, делать через VS Code можно из коробки, главное иметь Git на компьютере, и настроить чуток (https://habr.com/ru/articles/541258/).
### Ссылки на скачку
